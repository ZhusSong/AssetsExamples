		...
		SubShader
		{
			...
			Pass
			{
				...
				horizon = saturate((1 - horizon)) * ((_HorizonColorDay + midline * _HorizonLightDay) * saturate(_WorldSpaceLightPos0.y*10)
					...
					float3 color_1 = IntegrateScattering(rayStart, rayDir, rayLength, lightDir, lightColor);
